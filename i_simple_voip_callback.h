...
Simple VOIP callback interface.
...
#ifndef SIMPLE_VOIP_I_SIMPLE_VOIP_CALLBACK_H
#define SIMPLE_VOIP_I_SIMPLE_VOIP_CALLBACK_H
...
#endif  // SIMPLE_VOIP_I_SIMPLE_VOIP_CALLBACK_H
